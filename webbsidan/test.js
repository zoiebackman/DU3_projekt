...
button.addEventListener("click", function () {
    ...
    async function driver_4() { // Testar att skapa user med tomt inmatningsfält
    ...
    async function getPicture() { //hämta bild/bilder från API 
        const response = await fetch("https://api.pexels.com/v1/search?query=Tigers&per_page=1", {
            headers: {
    ...
    async function getQuizQuestions() {
        const response = await fetch(//Hämta frågor från API
